  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        'Una volta salvata l\'attività — dal recap subito dopo un allenamento tracciato, o riaprendola dal Calendario — puoi aggiungere fino ad altre 6 foto in una galleria a scorrimento: solo la prima (la copertina) si vede nel feed, le altre restano solo tue, un ricordo in più della sessione.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Vuoi un coach vocale? Attiva "Annunci vocali" sopra il pulsante del GPS, prima di partire: sentirai a voce il tempo di ogni chilometro, senza dover guardare lo schermo — utile se tieni il telefono in tasca o al braccio.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Tocca "Perché questo punteggio?" sotto la card per vedere il dettaglio: come sono messi carico, sonno, sforzo recente e riposo, uno per uno. Se un fattore manca (es. non hai ancora usato la card Recupero), te lo dice invece di ignorarlo in silenzio.',
        ...
        'Prima di tracciare col GPS (corsa, bici, camminata, trekking), nella scheda Registra puoi attivare "Allenamento a intervalli": scegli quante ripetute, la distanza e la zona target per il lavoro, la durata e la zona per il recupero. Durante il tracciamento un indicatore ti segue passo per passo e ti avvisa se esci dalla zona giusta — con gli Annunci vocali attivi, senti anche a voce quando inizia una ripetuta o il recupero.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'La torta "Come ti alleni" mostra ogni sport con il suo colore reale — lo stesso della sua icona in tutta l\'app — invece di sfumature di un unico colore: un colpo d\'occhio in più per riconoscere quale sport pesa di più.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'In cima alla scheda Amici trovi anche "Invita un amico": condividi il tuo link personale, e chi si registra da lì ti manda già una richiesta di amicizia — non serve spiegare a voce come cercarsi per username.',
  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        'Once the activity is saved — from the recap right after a tracked workout, or by reopening it from the Calendar — you can add up to 6 more photos in a scrollable gallery: only the first one (the cover) shows up in the feed, the rest stay just yours, one more memory of the session.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Want a voice coach? Turn on "Voice announcements" above the GPS button before you start: you\'ll hear the time of every kilometer out loud, without looking at the screen — handy if you keep your phone in a pocket or armband.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Tap "Why this score?" under the card to see the breakdown: how load, sleep, recent effort and rest each stand, one by one. If a factor is missing (e.g. you haven\'t used the Recovery card yet), it tells you instead of staying silent about it.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'The "How you train" pie chart shows every sport in its real color — the same as its icon everywhere else in the app — instead of shades of a single color: an extra glance to spot which sport weighs the most.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'At the top of the Friends tab you\'ll also find "Invite a friend": share your personal link, and whoever signs up from it already sends you a friend request — no need to explain how to search by username out loud.',
