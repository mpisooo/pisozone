...
const it = {
  ...
  friends: {
    ...
    profile: {
      ...
      vsMetricKm: 'Km',
      vsMetricKcal: 'Kcal',
      // Bacheca medaglie, numeri per sport, attività recenti (roadmap v7):
      // le prime due tollerano l'assenza delle RPC v50 (sezione nascosta),
      // le attività recenti si appoggiano alla RLS "friends" già esistente (v8).
      trophyHeading: 'Bacheca medaglie',
      trophyEmptyHint: 'Nessuna medaglia sbloccata ancora.',
      sportBreakdownHeading: 'Numeri per sport',
      recentActivitiesHeading: 'Attività recenti',
      recentActivitiesEmptyHint: 'Nessuna attività recente da mostrare.',
...
const en: Widen<typeof it> = {
  ...
  friends: {
    ...
    profile: {
      ...
      vsMetricKm: 'Km',
      vsMetricKcal: 'Kcal',
      trophyHeading: 'Trophy case',
      trophyEmptyHint: 'No medals unlocked yet.',
      sportBreakdownHeading: 'Numbers by sport',
      recentActivitiesHeading: 'Recent activities',
      recentActivitiesEmptyHint: 'No recent activities to show.',
